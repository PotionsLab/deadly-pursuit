...
export default class extends Phaser.State {
  ...
  preload () {
    ...
    this.rankBtn = this.add.button(25, game.world.height - 65, 'rankBtn', () => {}, this, 0, 0, 1);
    this.garageBtn = this.add.button(85, game.world.height - 65, 'garageBtn', () => {}, this, 0, 0, 1);
    this.settingsBtn = this.add.button(145, game.world.height - 65, 'settingsBtn', () => {}, this, 0, 0, 1);
